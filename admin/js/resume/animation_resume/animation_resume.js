$(function() {
    ...
    c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫彭勃，应届毕业生</div>");
    c.load("<div class='bef_comment writecode'>&nbsp;*我的工作可以提升用户的交互体验</div>",2000);
    ...
    c.load("<div class='bef_comment writecode'>&nbsp;*你是不是感觉后面的字体有点碍事</div>");
    ...
    w.load("<p><div class='writecode'>彭勃</div>");
    w.load("<div class='writecode'>Web前端开发</div>");
    w.load("<div class='writecode'>应届毕业生</div></p>");
    w.load("<h1 class='writecode'>联系我</h1>");
    w.load("<ul>");
    w.load("<li class='writecode'>mail:373427922@qq.com</li>");
    w.load("<li class='writecode'>blog:<a href='' target='_blank'>正在开发</a></li>");
    w.load("<li class='writecode'>github:<a href='https://github.com/mainbob' target='_blank'>https://github.com/mainbob</a></li>");
    w.load("</ul>");
    w.load("<h1 class='writecode'>技能</h1>");
    w.load("<ul>");
    w.load("<li class='writecode'>应届毕业生，有h5移动端已经pc端开发和设计的经验</li>");
    w.load("<li class='writecode'>比较熟练使用BOOTSTRAP,LAYUI,EASYUI,MUI,AUI等前端响应式框架</li>");
    w.load("<li class='writecode'>熟练各种Web前端开发技术H5,CSS3,jQuery</li>");
    w.load("<li class='writecode'>熟练制作符合W3标准的响应式网页</li>");
    w.load("<li class='writecode'>有一定的兼容性，移动适配，CSS性能优化的经验</li>");
    w.load("<li class='writecode'>有使用svn等常用版本管理工具</li>");
    w.load("</ul>");
    w.load("<h1 class='writecode'>外话</h1>");
    w.load("<ul>");
    w.load("<li class='writecode'>这个简单的简历如果不能满足你，请移步下方链接中的详细简历页面。</li>");
    w.load("<li class='writecode'><a href='' target='_blank'>点我进入详细简历页面</a></li>");
    w.load("</ul>");
    c.load("<p><div class='comment writecode'>/**</div>");
    ...
    c.load("<div class='comment writecode'>&nbsp;*QQ/微信:373427922/ZZZryel</div>");
    c.load("<div class='comment writecode'>&nbsp;*mobile:13789303256</div>");
    c.load("<div class='comment writecode'>&nbsp;*还有，如果可以的话，在网站的底部的左上方可以给我留言</div>");
